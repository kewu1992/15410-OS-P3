...
# directory.
#
STUDENTTESTS = small_program switched_program mutex_test coolness peon merchant io_test param_check vanish_check fork_wait_bomb fork_exit_bomb
###########################################################################
...
###########################################################################
SYSCALL_OBJS = syscall.o gettid.o fork.o exec.o new_pages.o remove_pages.o print.o halt.o readline.o vanish.o wait.o set_cursor_pos.o set_term_color.o set_status.o
