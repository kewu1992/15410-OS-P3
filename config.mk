...
#
KERNEL_OBJS = console_driver.o kernel.o loader.o malloc_wrappers.o asm_get_ebp.o asm_get_esp.o asm_new_process_iret.o init_IDT.o handler_wrapper.o vm.o asm_pf_handler.o asm_invalidate_tlb.o
